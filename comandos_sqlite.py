...
def ins_sub_grupo(linha):
    comando = """insert into tb_sub_grupo (
                    ...
                    DT_COMPETENCIA)
                values (?,?,?,?)"""
    dados = (linha[0:2].strip(), linha[2:4].strip(),
             linha[4:104].strip(), linha[104:110])
    return comando, dados
...
def ins_forma_organizacao(linha):
    comando = """insert into tb_forma_organizacao (
                ...
                values (?,?,?,?,?)"""
    dados = (linha[0:2].strip(), linha[2:4].strip(),
             linha[4:6].strip(), linha[6:106].strip(), linha[106:112])
    return comando, dados
...
def ins_cid(linha):
    comando = """insert into tb_cid (
                ...
                values (?,?,?,?,?,?)"""
    dados = (linha[0:4].strip(), linha[4:104].strip(), linha[104:105].strip(
    ), linha[105:106].strip(), linha[106:107].strip(), linha[107:111].strip())
    return comando, dados
...
def ins_componente_rede(linha):
    comando = """insert into tb_componente_rede (
                    ...
                    CO_REDE_ATENCAO)
                values (?,?,?)"""
    dados = (linha[0:10].strip(), linha[10:160].strip(), linha[160:163])
    return comando, dados
...
def ins_servico_classificacao(linha):
    comando = """insert into tb_servico_classificacao (
                    ...
                    DT_COMPETENCIA)
                values (?,?,?,?)"""
    dados = (linha[0:3], linha[3:6].strip(),
             linha[6:156].strip(), linha[156:162])
    return comando, dados
...
def ins_sia_sih(linha):
    comando = """insert into tb_sia_sih (
                    ...
                    DT_COMPETENCIA)
                values (?,?,?,?)"""
    dados = (linha[0:10].strip(), linha[10:110].strip(),
             linha[110:111].strip(), linha[111:117])
    return comando, dados
...
def ins_rl_excecao_compatibilidade(linha):
    comando = """insert into rl_excecao_compatibilidade (
                    ...
                    DT_COMPETENCIA)
                values (?,?,?,?,?,?,?)"""
    dados = (linha[0:10].strip(), linha[10:20].strip(), linha[20:22].strip(
    ), linha[22:32].strip(), linha[32:34].strip(), linha[34:35].strip(), linha[35:41])
    return comando, dados
...
def ins_rl_procedimento_cid(linha):
    comando = """insert into rl_procedimento_cid (
                    ...
                    DT_COMPETENCIA)
                values (?,?,?,?)"""
    dados = (linha[0:10], linha[10:14].strip(),
             linha[14:15].strip(), linha[15:21])
    return comando, dados
...
def ins_rl_procedimento_compativel(linha):
    comando = """insert into rl_procedimento_compativel (
                    ...
                    DT_COMPETENCIA)
                values (?,?,?,?,?,?,?)"""
    dados = (linha[0:10], linha[10:12].strip(), linha[12:22].strip(
    ), linha[22:24].strip(), linha[24:25].strip(), linha[25:29].strip(), linha[29:35])
    return comando, dados
...
def ins_rl_procedimento_sia_sih(linha):
    comando = """insert into rl_procedimento_sia_sih (
                    ...
                    DT_COMPETENCIA)
                values (?,?,?,?)"""
    dados = (linha[0:10], linha[10:20].strip(),
             linha[20:21].strip(), linha[21:27])
    return comando, dados
